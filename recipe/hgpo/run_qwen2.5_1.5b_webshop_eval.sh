...
eval_experiment_names=(
    # example: "k2_hgpo_length_step30_alpha1.0_baseGroup_False"
    # example: "k4_hgpo_length_step30_alpha1.0_baseGroup_False"
)
...
for eval_experiment_name in "${eval_experiment_names[@]}"; do
    ...
    eval_dir="${CHECKPOINTS_DIR}/qwen2.5_1.5b_webshop_train/${eval_experiment_name}"
    ...
    for seed in "${seeds[@]}"; do
        ...
        trainer.project_name="qwen2.5_1.5b_webshop_eval" \
