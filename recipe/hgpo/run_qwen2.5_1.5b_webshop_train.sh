...
project_name="qwen2.5_1.5b_webshop_train"
history_length=2 # history length 2 or 4
step_length=30 # max step

train_data_size=16
val_data_size=128
group_size=8
mode="mean_norm" # "mean_norm" or "mean_std_norm"
weight_type="length" # used by algorithm.hgpo.weight_type
...
experiment_name="k${history_length}_hgpo_${weight_type}_step${step_length}_alpha${length_weight_alpha}_baseGroup_${base_group}"
