...
project_name="qwen2.5_7b_webshop_train"
history_length=2
step_length=30
...
experiment_name="k${history_length}_hgpo_${weight_type}_step${step_length}_alpha${length_weight_alpha}"
