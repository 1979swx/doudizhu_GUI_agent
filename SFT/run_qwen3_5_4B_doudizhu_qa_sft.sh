...
DATA_DIR="${DATA_DIR:-data_synthesis/doudizhu_qa_sft}"
TRAIN_FILE="${TRAIN_FILE:-${DATA_DIR}/train.parquet}"
VAL_FILE="${VAL_FILE:-${DATA_DIR}/val.parquet}"

MODEL_PATH="${MODEL_PATH:-Qwen/Qwen3.5-4B}"
OUTPUT_DIR="${OUTPUT_DIR:-checkpoints/sft/qwen3_5_4B_doudizhu_qa}"
PROJECT_NAME="${PROJECT_NAME:-verl_agent_sft}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen3_5_doudizhu_qa_sft}"
...
require_file "${TRAIN_FILE}" "Generate QA data first with data_synthesis/doudizhu_qa_sft.py."
require_file "${VAL_FILE}" "Generate QA data first with data_synthesis/doudizhu_qa_sft.py."
