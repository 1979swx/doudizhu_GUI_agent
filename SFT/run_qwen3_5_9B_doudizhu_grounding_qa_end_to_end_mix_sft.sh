...
OUTPUT_DIR="${OUTPUT_DIR:-checkpoints/sft/qwen3_5_9B_doudizhu_grounding_qa_end_to_end_mix}"
PROJECT_NAME="${PROJECT_NAME:-verl_agent_sft}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen3_5_9b_doudizhu_grounding_qa_end_to_end_mix_sft}"
